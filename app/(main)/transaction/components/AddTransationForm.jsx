...
const AddTransationForm = ({ accounts, categories , initialData = null , editMode = false }) => {
    ...
    useEffect(() => {
        if (transactionResult?.success && !transactionLoading) {
            toast.success(editMode ? "Transaction successfully updated" : "Transaction successfully created")
            reset();
        ...
        <form className='space-y-6 pb-20' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                        ...
                        <SelectContent>
                            {accounts.map((account) => (
                                <SelectItem key={account.id} value={account.id}>{account.name} (₹{account.balance.toFixed(2)}) </SelectItem>
                            ))}
                            <CreateAccountDrawer>
                                <Button
                                    variant="ghost"
            ...
            <div className='flex items-center justify-between space-x-4 rounded-lg  border p-3'>
                <div className='space-y-1'>
                    <label className='text-sm font-medium cursor-pointer'>Recurring Transation</label>
...
export default AddTransationForm