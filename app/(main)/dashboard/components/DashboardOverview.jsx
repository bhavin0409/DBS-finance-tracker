...
const colors = ['#8884d8', '#82ca9d', '#ffc658', '#ff8042', '#8dd1e1', '#a4de6c', '#d0ed57', '#ffc0cb' , '#ffbb28', '#00C49F' , '#FF8042', '#0088FE' , '#FFBB28'];
                ...
                <CardContent>
                    <div>
                        {recentTransactions.length === 0 ? (
                            <p className='text-muted-foreground text-center py-4'>No recent transaction</p>
                        ) : (
